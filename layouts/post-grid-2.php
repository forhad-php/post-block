			...
			<article class="frhd__post-block-article">
				...
				<div class="frhd__post-meta">
					...
					if ( $post_author_show ) {
						...
						echo '<div class="frhd__post-author"><img src="' . esc_url( get_avatar_url( get_the_ID() ) ) . '" width="20" height="20"><span>By&nbsp;</span><strong>';
